...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{../outputs/figures/fig3_complexity_gap.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\linewidth]{augment_examples/all_augmentations_grid.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{../outputs/figures/fig2_search_space_colorjitter.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{../outputs/figures/fig1_stability_boxplot.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{../outputs/figures/fig5_cifar10_generalization.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{../outputs/figures/fig4_ablation_magnitude.png}
